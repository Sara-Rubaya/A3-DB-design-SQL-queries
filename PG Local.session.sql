...
CREATE TABLE Bookings (
    ...
    CONSTRAINT chk_bookings_pay_status  CHECK (payment_status IN ('Pending', 'Confirmed', 'Cancelled', 'Refunded') OR payment_status IS NULL)
);
...
-- Query 1: All Champions League matches with status 'Available'
SELECT
    match_id,
    fixture,
    base_ticket_price
